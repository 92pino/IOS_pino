...
// 반드시 성공하는 타입 변환
// ==> 부모 클래스거나 자기 자신
// Shape as Rectangle ==> 부모 클래스 -> 자식 클래스로 변환
...
let value = 1
//(value as Float) is Float   // 컴파일 error
(value as? Float) is Float  //  nil is Float ==> false
//(value as! Float) is Float  // 런타임 error
 ...
 */
//for elem in list {
//  if elem is Shape {                  // 자식 클래스 is 부모클래스 ==> true
